    ...
    <main>
      <div class="login">
        ...
        <div class="login-rightside">
          <form class="login-rightside__form" action="?c=UserController&m=registerProcess" method="post">
            <input
            ...
            />
            <input
              class="login-rightside__confirm-password"
              type="password"
              name="confirm"
              placeholder="Confirm Password"
            />
            <?php if (isset($_GET['failed'])) echo "Register Gagal. Silahkan Register Ulang" ?>

            <input class="login-rightside__submit" type="submit" value="Register"/>
          </form>
          ...
          <div class="login-rightside__description">
            ...
            <a href="?c=UserController&m=loginView"> Log in here!</a>
          </div>
        </div>
      </div>
    </main>
